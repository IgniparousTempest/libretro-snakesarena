...
struct Animation {
    ...
    Animation(Texture *texture, std::vector<Rect> frames, std::vector<int> frame_durations) : texture(texture),
              frames(std::move(frames)), frame_durations(std::move(frame_durations)) {
    ...
    Animation(Texture *texture, std::vector<Rect> frames, int frame_duration) :
              Animation(texture, std::move(frames), std::vector<int>(frames.size(), frame_duration)) {}
